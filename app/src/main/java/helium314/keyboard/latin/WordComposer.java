...
public final class WordComposer {
    ...
    public ArrayList<String> getNearbyLetterCandidatesForDigit(final helium314.keyboard.keyboard.Keyboard keyboard) {
        ...
        // 1. Direct standard number-row mapping (e.g., 1->q, 2->w, 3->e, 4->r, 5->t, 6->y, 7->u, 8->i, 9->o, 0->p)
        final char mappedChar;
        switch (digitChar) {
            case '1': mappedChar = 'q'; break;
            case '2': mappedChar = 'w'; break;
            case '3': mappedChar = 'e'; break;
            case '4': mappedChar = 'r'; break;
            case '5': mappedChar = 't'; break;
            case '6': mappedChar = 'y'; break;
            case '7': mappedChar = 'u'; break;
            case '8': mappedChar = 'i'; break;
            case '9': mappedChar = 'o'; break;
            case '0': mappedChar = 'p'; break;
            default: mappedChar = 0; break;
        }
        if (mappedChar != 0 && !candidateLetters.contains(mappedChar)) {
            candidateLetters.add(mappedChar);
        }
